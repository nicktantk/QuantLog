...
df.loc[df.zscore >= 0.5, ('positions_GLD_Short', 'positions_GDX_Short')] = [-1, 1]  # Short spread
df.loc[df.zscore <= -0.5, ('positions_GLD_Long', 'positions_GDX_Long')] = [1, -1]  # Buy spread
